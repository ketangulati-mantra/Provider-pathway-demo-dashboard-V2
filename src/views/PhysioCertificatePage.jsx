...
const physioConfig = {
  ...
  programName: 'PHYSIOTHERAPY PROVIDER PROGRAM',
  ...
  authorizedBy: 'MantraCare Physiotherapy Program',
  footer: 'Restoring movement and health. | mantracare.org',
  certificateIdPrefix: 'MC-PPP',
